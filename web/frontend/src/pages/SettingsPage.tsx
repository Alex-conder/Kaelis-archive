    ...
    <div className="h-full overflow-auto bg-[var(--bg-primary)]">
      ...
      <div className="max-w-5xl mx-auto px-4 pb-2">
        <div className="flex items-center gap-1 p-1 bg-[var(--bg-card)] rounded-xl border border-[var(--border-color)] w-fit">
          ...
          <a
            href="#/llm-settings"
            className="flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-medium transition-all text-[var(--text-muted)] hover:text-[var(--text-primary)] hover:bg-[var(--bg-secondary)]"
          >
